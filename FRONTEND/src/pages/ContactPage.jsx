...
const ContactPage = () => {
    return (
        <InfoPageLayout title="Contact Us">
            ...
            <ul>
                <li><strong>General Inquiries:</strong> <a href="mailto:akshaycodex@gmail.com">akshayCodex@gmail.com</a></li>
                <li><strong>Support:</strong> <a href="akshaycodex@gmail.com">akshaycodex@gmail.com</a></li>
